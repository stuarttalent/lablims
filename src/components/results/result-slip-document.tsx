    ...
    >
      ...
      <div className="p-8 pb-6 print:p-7">
        ...
        {order.includeAiCommentInReport && order.aiGeneratedComment ? (
          <section className="mt-8 overflow-hidden rounded-xl border border-indigo-200/90 bg-gradient-to-br from-indigo-50/90 to-white shadow-sm">
            <div className="border-b border-indigo-100 bg-indigo-950/90 px-4 py-2">
              <h3 className="text-[11px] font-bold uppercase tracking-wider text-white">
                Interpretive summary (AI-assisted)
              </h3>
            </div>
            <div className="px-5 py-4 text-[11px] leading-relaxed text-slate-800 whitespace-pre-wrap">
              {order.aiGeneratedComment}
            </div>
            <p className="border-t border-indigo-100 px-5 py-2 text-[9px] text-slate-500">
