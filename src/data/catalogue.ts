...
const PROFILE_TESTS: CatalogueTest[] = [
  {
    id: "profile-fbc-5part",
    name: "FBC profile (5-part differential)",
    loincCode: "57021-8",
    department: "Haematology",
    sampleType: "EDTA whole blood",
    turnaroundTime: "4 hours",
  ...
  },
  {
    ...
    units: "profile",
    referenceRange: "See constituent parameters",
    constituentTestIds: ["t-lipid-total", "t-lipid-hdl", "t-lipid-ldl", "t-lipid-tg"],
  },
];
